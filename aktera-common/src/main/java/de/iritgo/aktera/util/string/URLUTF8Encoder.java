...
/**
 * Class to encode a string into a form suitable for
 * inclusion in a URL, via the UTF-8 algorithm
 */
public class URLUTF8Encoder
{
	...
	/**
	 * Decode a UTF-8 encoded-string, returning the original
	 * string.
	 *
