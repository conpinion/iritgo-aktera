...
public class ModuleUpdateHandler extends UpdateHandler
{
					...
					ModuleVersion currentVersion, ModuleVersion newVersion) throws Exception
	{
		...
		if (currentVersion.lessThan ("2.2.1"))
		{
			...
			createTable ("AddressDataSource", "id serial primary key", "name varchar(255)",
							"type varchar(32) not null", "localCategory varchar(255)", "localCheckOwner boolean",
							"ldapAuthDn varchar(255)", "ldapAuthPassword varchar(255)", "ldapBaseDn varchar(255)",
							"ldapHost varchar(255)", "ldapPort int4", "ldapQuery varchar(255)",
							"ldapScope varchar(32)", "ldapPageSize int4", "ldapMaxEntries int4",
							"ldapAttributeNames text", "ldapSearchAttributes varchar(255)");
