...
public class AddressImportHandler implements ImportHandler
{
					...
					Properties properties) throws ModelException, XPathExpressionException
	{
		...
		String addressStoreId = (String) properties.getProperty ("destination", addressManager
					...
					Properties properties) throws ModelException, XPathExpressionException
	{
		...
		for (Node addressElem : new IterableNodeList (addressElems))
		{
			try
			{
				...
				address.get ().setSourceSystemClient (
				...
				address.get ().getPhoneNumberByCategory ("B").setNumber (
								StringTools.trim (xPath.evaluate ("phoneNumbers/phoneNumber[@category='B']",
												addressElem)));
				address.get ().getPhoneNumberByCategory ("BM").setNumber (
								StringTools.trim (xPath.evaluate ("phoneNumbers/phoneNumber[@category='BM']",
												addressElem)));
				address.get ().getPhoneNumberByCategory ("BF").setNumber (
								StringTools.trim (xPath.evaluate ("phoneNumbers/phoneNumber[@category='BF']",
												addressElem)));
				...
				address.get ().getPhoneNumberByCategory ("P").setNumber (
								StringTools.trim (xPath.evaluate ("phoneNumbers/phoneNumber[@category='P']",
												addressElem)));
				address.get ().getPhoneNumberByCategory ("PM").setNumber (
								StringTools.trim (xPath.evaluate ("phoneNumbers/phoneNumber[@category='PM']",
												addressElem)));
				address.get ().getPhoneNumberByCategory ("PF").setNumber (
								StringTools.trim (xPath.evaluate ("phoneNumbers/phoneNumber[@category='PF']",
												addressElem)));
