...
public class AddressCrudTest extends BrowserTestCase
{
	...
	protected void createAddress (Properties addressEntry)
	{
		...
		selenium.type ("address_phoneNumber_BM__number", addressEntry
						.getProperty ("address_phoneNumber_BM__number", ""));
		selenium.type ("address_phoneNumber_BF__number", addressEntry
						.getProperty ("address_phoneNumber_BF__number", ""));
		selenium.type ("address_phoneNumber_BDD__number", addressEntry.getProperty ("address_phoneNumber_BDD__number",
						""));
		selenium.type ("address_phoneNumber_P__number", addressEntry.getProperty ("address_phoneNumber_P__number", ""));
		selenium.type ("address_phoneNumber_PM__number", addressEntry
						.getProperty ("address_phoneNumber_PM__number", ""));
