...
public class UpdateHandler
{
		...
		throws SQLException
	{
		...
		int count = 1;
		List<Map<String, ?>> res = (List<Map<String, ?>>) new QueryRunner ().query (connection, "select "
						+ idColumnName + " from " + tableName, new MapListHandler ());
	...
	protected void createAutoIncrement (Persistent persistent, int initialId) throws PersistenceException
	{
		...
		idsPersistent.setField ("table_name", persistent.getName ().substring (
						persistent.getName ().lastIndexOf (".") + 1));
	...
	protected void createComponentSecurity (String component, String groupName, String operationsAllowed)
		throws SQLException
	{
		update ("INSERT INTO componentsecurity (component, groupname, operationsallowed) VALUES (?, ?, ?)",
						new Object[]
						{
					...
					String value, String validValues) throws SQLException
	{
		update ("INSERT INTO " + tableName
						+ " (id, category, name, type, value, validValues) VALUES (?, ?, ?, ?, ?, ?)", new Object[]
		{
	...
	protected void createSystemConfigEntry (String category, String name, String type, String value)
		throws SQLException
	{
	...
	protected void createSystemConfigEntryIfNotExists (String category, String name, String type, String value)
		throws SQLException
	{
		long count = (Long) query ("SELECT count (*) FROM SystemConfig WHERE category = '" + category
						+ "' AND name = '" + name + "'", new ScalarHandler ());
	...
	protected void renameIdColumn (String tableName, String oldIdColumnName, String newIdColumnName)
		throws SQLException
	{
	...
	{
		return String.valueOf (query ("select " + field + " from " + tableName + " where " + where,
						new ScalarHandler ()));
	}
	...
	{
		return (List<Map<String, Object>>) query ("select * from " + tableName + " where " + where,
						new MapListHandler ());
	}
	...
	public void updateDatabase (@SuppressWarnings("unused") ModelRequest req,
					@SuppressWarnings("unused") Logger logger, @SuppressWarnings("unused") Connection connection,
