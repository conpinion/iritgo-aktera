...
import de.iritgo.aktera.journal.command.RefreshJournal;
import de.iritgo.aktera.journal.command.RefreshJournalPaneCommand;
import de.iritgo.aktera.journal.command.ShowEmbeddedJournal;


/**
 *
 */
public class AkteraJournalPlugin extends FrameworkPlugin
{
	/**
