 ...
 * @version 1.0
 */
public class UidPrincipal implements Principal, java.io.Serializable
{
	private String name;
	 ...
	 *
	 */
	public UidPrincipal(String newName)
	{
		name = newName;
	}
	...
	public boolean equals(Object o)
	{
		...
		if (o instanceof UidPrincipal)
		{
			if (((UidPrincipal) o).getName().equals(name))
			{
				return true;
			}
			else
