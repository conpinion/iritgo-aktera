...
public class GroupPrincipal implements Principal, java.io.Serializable
{
	...
	/**
	 * Create a <code>GroupPrincipal</code> with no
	 * user name.
	 *
	 */
	 ...
	 *
	 */
	public GroupPrincipal (String newName)
	{
		name = newName;
	}
	 ...
	 * <code>GroupPrincipal</code> and the two
	 * GroupPrincipals have the same name.
	 *
	 * <p>
	 *
	...
	public boolean equals (Object o)
	{
		...
		{
			if (((GroupPrincipal) o).getName ().equals (name))
			{
				return true;
			}
			else
