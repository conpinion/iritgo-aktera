 ...
 * @x-avalon.info name="de.iritgo.aktera.scheduler.MoveScheduleDown"
 * @x-avalon.lifestyle type="singleton"
 * @model.model
 *   name="de.iritgo.aktera.scheduler.MoveScheduleDown"
 *   id="de.iritgo.aktera.scheduler.MoveScheduleDown"
 *   logger="aktera"
 */
public class MoveScheduleDown extends AbstractListCommandModel
{
	/**
