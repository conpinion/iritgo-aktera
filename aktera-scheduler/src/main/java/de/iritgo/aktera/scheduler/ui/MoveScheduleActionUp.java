...
/**
 * This model moves schedule actions one position up.
 *
 * @avalon.component
 * @avalon.service type="de.iritgo.aktera.model.Model"
 * @x-avalon.info name="de.iritgo.aktera.scheduler.MoveScheduleActionUp"
 * @x-avalon.lifestyle type="singleton"
 * @model.model
 *   name="de.iritgo.aktera.scheduler.MoveScheduleActionUp"
 *   id="de.iritgo.aktera.scheduler.MoveScheduleActionUp"
 *   logger="aktera"
 */
public class MoveScheduleActionUp extends AbstractListCommandModel
{
	/**
	 *
	 */
	public MoveScheduleActionUp ()
	{
		super ("actionId");
	}
	...
	{
		moveScheduleActionUp (request, id);
	}
	 ...
	 * @param id The schedule action id
