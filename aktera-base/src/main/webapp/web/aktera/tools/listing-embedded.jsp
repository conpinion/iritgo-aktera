...
<logic:present name="<%= listId %>">
			...
			<div class="t"><div class="b"><div class="l"><div class="r"><div class="bl"><div class="br"><div class="tl"><div class="tr">
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<logic:equal name="<%= listId %>" property="attributes.commandStyle" value="header">
	...
	<bean:define id="formName" type="java.lang.String">formular</bean:define>
...
<!--
	...
	function <%= listId %>UncheckAll()
	{
		if (document.<%= formName %>.<%= keyName %>.length == undefined)
		{
			document.<%= formName %>.<%= keyName %>.checked = document.<%= formName %>.selectAll.unchecked;
		}
		else
		{
			for (i = 0; i < document.<%= formName %>.<%= keyName %>.length; i++)
			{
				document.<%= formName %>.<%= keyName %>[i].checked = document.<%= formName %>.selectAll.unchecked;
			}
		}
	}
