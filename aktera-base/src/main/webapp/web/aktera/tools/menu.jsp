			...
			<tr class="normal">
				...
				<td class="item">
					...
					<logic:present name="item" property="attributes.icon">
						<xhtml:img path="/aktera/images/std/" name="item" property="attributes.icon" align="middle"/>&nbsp;&nbsp;
					</logic:present>
					<logic:notPresent name="item" property="attributes.icon">
						<xhtml:themeImg src="menu-bullet" align="middle"/>&nbsp;&nbsp;
					</logic:notPresent>

					<xkeel:command link="true" name="item" styleClass="menu" title="<%= label %>" bundle="<%= bundle %>">
