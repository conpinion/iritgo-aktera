...
<tiles:insert beanName="site-template" flush="true">
	...
	<tiles:put name="title" type="string">
		<bean:message key="analyzeImport" bundle="Aktera" />
	</tiles:put>
	...
	<tiles:put name="content" type="string">
		<center>
			<logic:present name="report">
				...
				<br>
				<br>
				<bean:message key="importAnalyzeReport" bundle="Aktera" />
				<br>
				<br>
			...
			<logic:notPresent name="report">
				...
				<br>
				<h1>
					<bean:message key="importAllreadyRunning1" bundle="Aktera" />
				</h1>
				<br>
				<bean:message key="importAllreadyRunning2" bundle="Aktera" />
				<br>
				<br>
				<bean:message key="importAllreadyRunning3" bundle="Aktera" />
				<br>
				<br>
				<br>
				<br>
