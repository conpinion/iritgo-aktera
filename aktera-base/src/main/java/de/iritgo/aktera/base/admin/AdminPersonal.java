 ...
 * @x-avalon.info name="aktera.admin.personal"
 * @x-avalon.lifestyle type="singleton"
 * @model.model name="aktera.admin.personal" id="aktera.admin.personal" logger="aktera"
 * @model.attribute name="forward" value="aktera.admin.personal"
 */
