 ...
 *
 */
public class HoursMultiSelectTag extends org.apache.struts.taglib.html.BaseInputTag
{
	/** */
	...
	public int doStartTag () throws JspException
	{
		...
		for (int i = 0; i < 6; ++i)
		{
			...
			for (int j = 0; j < 4; ++j)
			{
				results.append ("<option value=\"" + hour + "\"");
