 ...
 *
 */
public class MinutesMultiSelectTag extends org.apache.struts.taglib.html.BaseInputTag
{
	/** */
	...
	public int doStartTag() throws JspException
	{
		...
		if (value != null)
		{
			selectedMinutes = "," + value.toString() + ",";
		}
		else
		{
		...
		for (int i = 0; i < 10; ++i)
		{
			...
			for (int j = 0; j < 6; ++j)
			{
				results.append("<option value=\"" + minute + "\"");

				if (selectedMinutes.indexOf("," + minute + ",") != - 1)
				{
					results.append(" selected=\"true\"");
				}

				results.append(">" + minute + "</option>");
				++minute;
			}
